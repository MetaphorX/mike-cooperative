...
const Signup = () => {
    ...
    const handleLogin = () =>{
        const fixedEmail = "mike@blockchain.cooperative.com";
        const fixedPassword = "member12345";
            ...
            <div className="flex flex-col items-center justify-center">
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-4">
                    ...
                    <div>
                        ...
                        aria-label="enter email adress" role="input" type="email" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                    </div>
                    ...
                    <div className="mt-8">
                        <button role="button" 
                        onClick={handleLogin}
                        aria-label="create my account" className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">
                            Login
                        </button>
                    </div>
                </div>
